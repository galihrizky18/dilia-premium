...
<div class="body flex flex-row">
    ...
    <div id="bodyUsers" class="content sm:ml-[20%] h-[1000px] p-3 font-della w-full">
                    ...
                    <form action="">
                        ...
                        <div class="menu-filter mt-2 px-4 grid grid-cols-2 gap-5 w-[50%] py-3">
                            ...
                            <div class="tombol flex flex-col justify-end items-center">
                                <button type="submit"
                                    class="bg-gray-400 w-[90%] text-white font-bold p-[0.3rem] rounded-xl hover:bg-gray-500 transition">Filter</button>
                            </div>
                        </div>
                    </form>
                </div>
